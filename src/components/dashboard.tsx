...
<MiniStatistic image="https://img.favpng.com/21/3/18/computer-icons-clip-art-portable-network-graphics-system-administrator-user-png-favpng-P8LVNtfaNewQkVVxgSgqiy0Tk.jpg" person='KakiTangan' value={50}/>
  </SimpleGrid>
